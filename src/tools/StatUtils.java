...
public class StatUtils {
	 ...
	 * @return The sample standard deviation.
	 */
	public static double standardDeviationSample(double data[], double mean){
		double tmp = 0;
		for (int i = 0; i < data.length; i++) {
			tmp += Math.pow(data[i] - mean,2);
		}
	 ...
	 */
	public static double covarianceSample(double data1[], double data2[], double d1mean, double d2mean){
